...
- [ ] 1.3 Add narrowly-scoped extractors for other explicit ownership and
...
- [x] 2.2 Prioritise never-validated and unknown assertions with an explainable
  ...
  history", SPEC-0001).
- [ ] 2.3 Add predicate-specific validators for further authoritative source
...
- [ ] 2.4 Provide an external scheduled sweep runner with a bounded work budget
...
- [x] 3.1 Migrate legacy facts and candidates idempotently into structural
  ...
  SPEC-0001).
- [ ] 3.2 Add interrupted-projection recovery, SQLite error-context, and
  assertion-derived SQL safety tests (REQ "R8 Database Operation Standards" and
  "R7 Error Handling Standards", SPEC-0001).
- [ ] 3.3 Add a fixture corpus for repository/date isolation and graph-neighbour
